...
- Crea tu base de datos y tablas correspondientes a partir de las tareas de los modelos e-r y relacional.

- Inlcuye al menos 20 registros en tu base de datos
